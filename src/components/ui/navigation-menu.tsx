  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        ...
        "data-[starting-style]:data-[activation-direction=left]:translate-x-[-50%] rtl:data-[starting-style]:data-[activation-direction=left]:-translate-x-[-50%] ",
        "data-[starting-style]:data-[activation-direction=right]:translate-x-[50%] rtl:data-[starting-style]:data-[activation-direction=right]:-translate-x-[50%] ",
        "data-[ending-style]:data-[activation-direction=left]:translate-x-[50%] rtl:data-[ending-style]:data-[activation-direction=left]:-translate-x-[50%] ",
        "data-[ending-style]:data-[activation-direction=right]:translate-x-[-50%] rtl:data-[ending-style]:data-[activation-direction=right]:-translate-x-[-50%]",
        className
      )}
      {...props}
    />
  ...
  return (
    <NavigationMenuPrimitive.Portal>
      <NavigationMenuPrimitive.Positioner
        ...
        className={cn(
          "z-50 box-border h-[var(--positioner-height)] w-[var(--positioner-width)] max-w-[var(--available-width)] transition-[top,left,right,bottom] duration-[var(--duration)] ease-[var(--easing)] before:absolute before:content-[''] data-[instant]:transition-none data-[side=bottom]:before:top-[-10px] data-[side=bottom]:before:end-0 data-[side=bottom]:before:start-0 data-[side=bottom]:before:h-2.5 data-[side=left]:before:top-0 data-[side=left]:before:right-[-10px] data-[side=left]:before:bottom-0 data-[side=left]:before:w-2.5 data-[side=right]:before:top-0 data-[side=right]:before:bottom-0 data-[side=right]:before:left-[-10px] data-[side=right]:before:w-2.5 data-[side=top]:before:end-0 data-[side=top]:before:bottom-[-10px] data-[side=top]:before:start-0 data-[side=top]:before:h-2.5",
          className
        )}
        style={
          {
