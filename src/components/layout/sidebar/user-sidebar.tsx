...
import { UserSidebarMenuGroup } from "./components/sidebar-menu-group";
import { SidebarLogo } from "./sidebar-logo";
import { createLocalePath } from "./utils/sidebar-path";
import { UserSidebarFooter } from "./sidebar-footer";
...
export function UserSidebar({ side, locale, dictionary }: UserSidebarProps) {
    ...
    >
      ...
      <SidebarFooter className="p-0 bg-background">
        <div className="rounded-t-lg  bg-foreground/5 py-6 group-data-[collapsible=icon]:py-4 p-2 ">
          <UserSidebarFooter logoutLabel={dictionary.logout} />
        </div>
      </SidebarFooter>
    </Sidebar>
  );
